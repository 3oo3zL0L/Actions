...
var SOURCES = {
  // Vandaag en de volgende werkdag (B4; op vrijdag maandag): tot het begin van de dag erna.
  cal: { server: M365, tool: "outlook_calendar_search", input: function () { var d = startOfDay(new Date()); d.setDate(d.getDate() + nextDayOffset() + 1); return { query: "*", afterDateTime: "today", beforeDateTime: isoDay(d), limit: 25 }; }, every: 300000 },
