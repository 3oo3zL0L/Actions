...
Doel: bijhouden hoe Thomas de Actiepagina echt gebruikt en daaruit concrete verbeteringen voor het team halen.

## Ritme
Elke maandag 07:00 (Amsterdam) start een geplande ronde in de PO-sessie. De PO zet de analist aan het werk,
beoordeelt het rapport en zet de voorstellen in het verbeterpunten-document.
...
## Rapport (kort, Nederlands, geen em-dashes)
1. **Gebruik afgelopen week**: top 5 gebruikte functies, functies die niet gebruikt worden, aantal Claude-vragen.
...
alleen tellingen en de eigen Claude-vragen. Voorstellen zijn advies: de PO en Thomas beslissen.
